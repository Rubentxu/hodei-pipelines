...
use hodei_pipelines_domain::{
    DomainError, Result,
    identity_access::value_objects::security::{Email, Permission, Role, User, UserId, UserStatus},
};
use std::result::Result as StdResult;
use std::str::FromStr;
use hodei_pipelines_ports::EventPublisher;
...
impl From<DomainError> for SecurityManagementError {
    fn from(error: DomainError) -> Self {
        match error {
            DomainError::Validation(msg) => SecurityManagementError::Validation(msg),
            _ => SecurityManagementError::DomainError(error.to_string()),
        }
    }
}

impl From<SecurityManagementError> for DomainError {
    fn from(error: SecurityManagementError) -> Self {
...
pub trait UserRepository: Send + Sync {
    async fn save(&self, user: &User) -> StdResult<(), UserRepositoryError>;
    async fn find_by_id(&self, id: &UserId) -> StdResult<Option<User>, UserRepositoryError>;
    async fn find_by_email(&self, email: &Email) -> StdResult<Option<User>, UserRepositoryError>;
    async fn list_all(&self) -> StdResult<Vec<User>, UserRepositoryError>;
    async fn delete(&self, id: &UserId) -> StdResult<(), UserRepositoryError>;
    async fn exists(&self, id: &UserId) -> StdResult<bool, UserRepositoryError>;
}
    ...
    E: EventPublisher,
{
    ...
    pub async fn create_user(&self, request: CreateUserRequest) -> Result<UserResponse> {
        ...
        // Publish event
        // TODO: Add UserCreated event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn update_user(
        ...
        // Publish event
        // TODO: Add UserUpdated event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn delete_user(&self, id: String) -> Result<()> {
        ...
        // Publish event
        // TODO: Add UserDeleted event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn activate_user(&self, id: String) -> Result<UserResponse> {
        ...
        // TODO: Add UserActivated event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn deactivate_user(&self, id: String) -> Result<UserResponse> {
        ...
        // TODO: Add UserDeactivated event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn suspend_user(&self, id: String) -> Result<UserResponse> {
        ...
        // TODO: Add UserSuspended event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn add_role_to_user(&self, id: String, role: String) -> Result<UserResponse> {
        ...
        // TODO: Add UserRoleAdded event to SystemEvent enum
        // let _ = self
        //     .event_bus
    ...
    pub async fn remove_role_from_user(&self, id: String, role: String) -> Result<UserResponse> {
        ...
        // TODO: Add UserRoleRemoved event to SystemEvent enum
        // let _ = self
        //     .event_bus
