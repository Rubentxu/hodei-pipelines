...
use hodei_pipelines_domain::{ExecutionId, PipelineId};
use hodei_pipelines_domain::{JobId, JobSpec, WorkerId};
...
pub enum SystemEvent {
    ...
    PipelineCreated(hodei_pipelines_domain::Pipeline),
...
mod tests {
    use super::*;
    use chrono::Utc;
    use hodei_pipelines_domain::{JobId, JobSpec, ResourceQuota, WorkerId};
    ...
    fn test_system_event_pipeline_created_serialization() {
        use hodei_pipelines_domain::{Pipeline, PipelineId};
