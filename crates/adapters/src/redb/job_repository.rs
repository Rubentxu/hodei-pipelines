...
impl JobRepository for RedbJobRepository {
    ...
    async fn compare_and_swap_status(
        ...
        // Update state
        let updated_job = Job {
            state: hodei_pipelines_domain::JobState::try_from_str(new_state).map_err(|_| {
...
mod tests {
    use super::*;
    use hodei_pipelines_domain::JobSpec;
    ...
    async fn test_redb_job_save_and_retrieve() {
        ...
        let job_spec = JobSpec {
            ...
            resources: hodei_pipelines_domain::ResourceQuota::default(),
            timeout_ms: 300000,
            retries: 3,
            env: HashMap::new(),
            secret_refs: Vec::new(),
    ...
    async fn test_redb_job_get_pending_jobs() {
        ...
        job2.state = hodei_pipelines_domain::JobState::Running;
