...
impl TenantQuotaDto {
    fn to_domain(self) -> Result<TenantQuota, String> {
        ...
        let quota_limits = hodei_pipelines_modules::multi_tenancy_quota_manager::QuotaLimits {
...
impl WFQIntegrationService {
    ...
    pub async fn enqueue_request(&self, request: ResourceRequestDto) -> Result<(), String> {
        ...
        let priority = match request.queue_priority {
            0 => hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::Critical,
            1 => hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::High,
            2 => hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::Normal,
            3 => hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::Low,
            _ => hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::Batch,
        };

        let resource_request = hodei_pipelines_modules::multi_tenancy_quota_manager::ResourceRequest {
...
mod tests {
    ...
    use hodei_pipelines_modules::weighted_fair_queuing::{WFQConfig, WeightStrategy};
