...
use hodei_pipelines_domain::{
    ...
    pipeline_execution::entities::pipeline::{PipelineId, PipelineStepId},
};
...
pub struct PipelineApiAppState {
    ...
    pub execution_service: Arc<dyn hodei_pipelines_application::PipelineExecutionService>,
}

impl PipelineApiAppState {
    pub fn new(
        service: Arc<dyn PipelineService>,
        execution_service: Arc<dyn hodei_pipelines_application::PipelineExecutionService>,
    ) -> Self {
        Self {
