...
impl ResourceQuotasService {
    ...
    pub async fn check_quota(
        ...
        let resource_request = ResourceRequest {
            ...
            priority: hodei_pipelines_modules::multi_tenancy_quota_manager::JobPriority::Normal,
        };
...
mod tests {
    ...
    fn create_test_quota_manager() -> Arc<MultiTenancyQuotaManager> {
        let config = hodei_pipelines_modules::multi_tenancy_quota_manager::QuotaManagerConfig::default();
