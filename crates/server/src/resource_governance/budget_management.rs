...
#[utoipa::path(
    ...
    tag = "cost-management",
    responses(
        (status = 200, description = "Budgets retrieved successfully", body = Vec<Budget>)
    )
)]
...
#[utoipa::path(
    get,
    path = "/api/v1/costs/budgets/usage/{tenant_id}",
    tag = "cost-management",
    responses(
        (status = 200, description = "Budget usage retrieved successfully", body = BudgetUsage),
        (status = 404, description = "Budget not found")
    )
)]
...
#[utoipa::path(
    get,
    path = "/api/v1/costs/budgets/alerts/{tenant_id}",
    tag = "cost-management",
    responses(
        (status = 200, description = "Budget alerts retrieved successfully", body = Vec<BudgetAlert>)
    )
)]
...
#[utoipa::path(
    post,
    path = "/api/v1/costs/budgets/check-alerts/{tenant_id}",
    tag = "cost-management",
    responses(
        (status = 200, description = "Budget alerts checked successfully", body = Vec<BudgetAlert>)
    )
)]
