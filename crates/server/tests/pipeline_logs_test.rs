...
use hodei_pipelines_core::pipeline_execution::{
...
async fn test_get_execution_logs_handler_success() {
    ...
    let step_id = hodei_pipelines_core::pipeline::PipelineStepId::new();
    ...
    step_execution.status =
        hodei_pipelines_core::pipeline_execution::StepExecutionStatus::COMPLETED;
    ...
    let job_spec = hodei_pipelines_core::job::JobSpec {
        ...
        resources: hodei_pipelines_core::job::ResourceQuota::default(),
        timeout_ms: 30000,
        retries: 3,
        env: HashMap::new(),
        secret_refs: vec![],
    ...
    let pipeline_step = hodei_pipelines_core::pipeline::PipelineStep {
        id: step_id,
