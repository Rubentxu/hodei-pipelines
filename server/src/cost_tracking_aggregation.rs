...
pub fn cost_tracking_api_routes() -> Router<CostTrackingApiAppState> {
    Router::new()
        .route("/costs/summary", get(get_cost_summary_handler))
        .route("/costs/by-resource", get(get_cost_by_resource_handler))
        .route("/costs/by-tenant", get(get_cost_by_tenant_handler))
        .route("/costs/trends", get(get_cost_trends_handler))
}
