...
use hodei_pipelines_domain::shared_kernel::circuit_breaker::{CircuitBreaker, CircuitBreakerConfig};
use hodei_pipelines_domain::{JobId, JobSpec};
use hodei_pipelines_domain::{WorkerId, WorkerStatus};
...
impl WorkerClient for GrpcWorkerClient {
    ...
    async fn send_heartbeat(
        ...
        // Convert hodei_pipelines_domain::ResourceUsage to proto format
