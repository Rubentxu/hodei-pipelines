...
use hodei_pipelines_domain::{Job, JobId, JobSpec, Pipeline, PipelineId, Result};
    ...
    P: PipelineRepository,
{
    ...
    pub async fn create_pipeline(
        &self,
        name: String,
        steps: Vec<hodei_pipelines_domain::pipeline_execution::entities::pipeline::PipelineStep>,
    ) -> Result<Pipeline> {
...
impl From<OrchestratorError> for hodei_pipelines_domain::DomainError {
